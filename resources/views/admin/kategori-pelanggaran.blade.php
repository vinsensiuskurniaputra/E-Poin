...
@section('container')
    <div class="flex">
        ...
        <div class="w-full">
            <div class="hidden md:grid p-5 bg-[#610094]">
                <form class="flex items-center" action="/admin/kategori-pelanggaran">
            ...
            <div class="mt-20 mx-10 mb-10 md:mt-10">
                <div class="flex mb-5">
                    ...
                    @error('poin')
                        <span id="badge-dismiss-red"
                            class="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-red-800 bg-red-100 rounded">
                            {{ $message }}
                            <button type="button"
                                class="inline-flex items-center p-0.5 ml-2 text-sm text-red-400 bg-transparent rounded-sm hover:bg-red-200 hover:text-red-900 dark:hover:bg-red-300 dark:hover:text-red-900"
                                data-dismiss-target="#badge-dismiss-red" aria-label="Remove">
                ...
                <div class="flex leading-6">
                    <h1 class="font-bold text-xl">Kategori Pelanggaran</h1>
                    <button type="button" data-modal-toggle="tambah-kategori"
                    ...
                    <table class="mt-10 w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-white bg-[#3F0071] rounded-full">
                            <tr>
                                ...
                                <th scope="col" class="py-3 px-6">Poin Yang Didapat</th>
                        ...
                        <tbody>
                            @foreach ($kategoris as $kategori)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="py-4 px-6"> {{ $kategori->poin }} </td>
                                    <td class="py-4 px-6 flex gap-2">
                                        <button type="button" data-modal-toggle="hapus-{{ $loop->index }}"
                                    ...
                                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <form action="/admin/kategori-pelanggaran/{{ $kategori->id }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button data-modal-toggle="hapus-{{ $loop->index }}" type="submit"
                                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                        Yes, I'm sure
                                                    </button>
                                                </form>
                                                <button data-modal-toggle="hapus-{{ $loop->index }}" type="button"
                                                ...
                                                <form action="/admin/kategori-pelanggaran/{{ $kategori->id }}"
                                                    ...
                                                    <div class="grid mt-3">
                                                        <div class="relative z-0 mb-6 w-full group">
                                                            <input type="text" name="name" id="kategori"
                                                        ...
                                                        <div class="relative z-0 mb-6 w-full group">
                                                            <input type="text" name="poin" id="poin"
                                                                ...
                                                                value="{{ $kategori->poin }}" />
                                                            <label for="poin"
                                                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#1C0C5B] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Jumlah
                                                                Poin</label>
                                                        </div>
                                                    </div>
                                                    <button type="submit"
    ...
    <!-- Pop Up Modal -->
    <div id="tambah-kategori" tabindex="-1"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                ...
                <div class="p-6">
                    ...
                    <form action="/admin/kategori-pelanggaran" method="POST">
                        @csrf
                        <div class="grid mt-3">
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="text" name="name" id="kategori"
