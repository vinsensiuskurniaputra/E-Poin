        ...
        <div class="w-full">
            ...
            <div class="mt-20 mx-10 mb-10 md:mt-10">
                ...
                <div class="flex leading-6">
                    ...
                    <button type="button" data-modal-toggle="tambah-siswa"
                            ...
                            @foreach ($students as $student)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6 flex gap-2">
                                        <form action="/admin/daftar-siswa/{{ $student->id }}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <button type="submit"
                                                onclick="return confirm('Apakah Anda Yakin Ingin Menghapus {{ $student->name }}')"
                                                class="grid border border-red-500 p-2 rounded-lg hover:bg-red-500 h-10 w-10 text-center group">
                                                <svg width="15" height="17" class="m-auto" viewBox="0 0 15 17"
                                        ...
                                        <a href="/admin/edit-siswa/{{ $student->id }}"
                                            class="grid border border-green-500 p-2 rounded-lg h-10 w-10 text-center hover:bg-green-500 group">
                                            <svg width="15" height="17" class="m-auto" viewBox="0 0 15 17"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="tambah-siswa" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <h3 class="mb-4 text-xl font-medium text-gray-900">Tambah Siswa</h3>
                    <form action="/admin/daftar-siswa" method="POST">
                        @csrf
                        <div class="grid mt-3">
                            ...
                            <div class="mb-3 w-full">
                                ...
                                <select id="select-state" class="mt-3" name="the_class_id"
