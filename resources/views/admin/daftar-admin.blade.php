        ...
        <div class="w-full">
            ...
            <div class="mt-20 mx-10 mb-10 md:mt-10">
                ...
                <div class="flex leading-6">
                    <h1 class="font-bold text-xl">Daftar Admin</h1>
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    ...
                    <form action="/admin/daftar-admin" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="grid">
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6">
                        ...
                        <form action="/admin/daftar-admin/{{ $user->id }}" method="POST"
