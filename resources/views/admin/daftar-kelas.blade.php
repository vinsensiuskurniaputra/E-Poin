        ...
        <div class="w-full">
            ...
            <div class="mt-20 mx-10 mb-10 md:mt-10">
                ...
                <div class="flex leading-6">
                    <h1 class="font-bold text-xl">Daftar Kelas</h1>
                    <button type="button" data-modal-toggle="tambah-kelas"
                    ...
                    <table class="mt-10 w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-white bg-[#3F0071] rounded-full">
                            <tr>
                                ...
                                <th scope="col" class="py-3 px-6">Total Murid</th>
                        ...
                        <tbody>
                            @foreach ($classes as $class)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6"> {{ $class->student->count() }} </td>
    ...
    <div id="tambah-kelas" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <h3 class="mb-4 text-xl font-medium text-gray-900">Tambah Kelas</h3>
                    <form action="/admin/daftar-kelas" method="POST">
                        @csrf
                        <div class="grid">
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="text" name="name" id="kelas"
        ...
        <div id="hapus-{{ $loop->index }}" tabindex="-1"
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center grid">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Apakah anda yakin ingin menghapus Kelas {{ $class->name }}?
                        </h3>
                        <form action="/admin/daftar-kelas/{{ $class->id }}" method="POST" class="flex mx-auto">
                            @method('delete')
                            @csrf
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6">
                        ...
                        <form action="/admin/daftar-kelas/{{ $class->id }}" method="POST">
                            @method('put')
                            @csrf
                            <div class="grid mt-3">
                                <div class="relative z-0 mb-6 w-full group">
                                    <input type="text" name="name" id="kategori"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#1C0C5B] peer"
                                        placeholder=" " required="" value="{{ $class->name }}" />
                                    <label for="kategori"
                                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#1C0C5B] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama
