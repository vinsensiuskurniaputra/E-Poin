                    ...
                    @foreach ($pelanggarans as $pelanggaran)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6 flex gap-2">
                                <form action="/user/history/{{ $pelanggaran->id }}" method="POST">
                                    @method('delete')
                                    @csrf
                                    <button type="submit"
                                ...
                                <button type="button" data-modal-toggle="edit-{{ $loop->index }}"
                                    ...
                                    <svg width="15" height="17" class="mx-auto" viewBox="0 0 15 17" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" class="group-hover:fill-white"
